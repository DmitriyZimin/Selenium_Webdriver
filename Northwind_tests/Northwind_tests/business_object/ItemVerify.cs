...
namespace Northwind_tests.business_object
{
    class ItemVerify
    {
        ...
        public ItemVerify(string selectName, string selectCategory, string selectSupplier, string selectPrice, string selectQuantity, string selectInstock, string selectOnorder, string selectReorder)
        {
